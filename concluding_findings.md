# Progressive Curriculum and Hyperparameter Optimization for Legged Locomotion on Challenging Terrains

This document details the development and optimization of a reinforcement learning (RL) policy for quadrupedal locomotion (ANYmal C) using Proximal Policy Optimization (PPO) in NVIDIA Isaac Sim / Isaac Lab.
